...
<form class="ui form">
    ...
    <h4 class="ui dividing header">Gasto</h4>
    <div class="fields">
        <div class="four wide field">
            <label>Gasto em</label>
            <input type="date" name="gastoem">
        </div>
    ...
    <button class="ui right floated positive button" type="submit" formaction="despesa-adicionar-salvar.php" formmethod="POST"><i class="save icon"></i>Salvar</button>
    <!-- botões do formulário -->
    <?php foreach ($tags as $index => $tag) : ?>
