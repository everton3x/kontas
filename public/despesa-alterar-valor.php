...
<form class="ui form">
    ...
    <button class="ui right floated positive button" type="submit" formaction="despesa-alterar-valor-salvar.php" formmethod="POST"><i class="save icon"></i>Salvar</button>
    <!-- botões do formulário -->
</form><!-- formulário -->
