...
$repeticao = 0;
if (key_exists('repeticao', $_POST)) $repeticao = $_POST['repeticao'];
...
<div class="ui breadcrumb">
    ...
    <div class="divider"> / </div>
    <div class="active section">Repetir</div>
</div><!-- trilha -->
...
<form class="ui form">
    ...
    <div class="fields">
        ...
        <div class="three wide required field">
            ...
            <input type="number" name="repeticoes" required value="<?= $repeticoes; ?>" min="2" step="1">
        </div>
    </div>
    <div class="required field">
        <label>Descrição</label>
        <input type="text" name="descricao" required placeholder="Descreva a despesa" value="<?= $descricao; ?>" autocomplete="off">
    </div>
    <div class="fields">
        <div class="three wide required field">
            <label>Valor</label>
    ...
    <div class="fiels">
        <div class="three wide field">
            <div class="ui action input">
                ...
                <button class="ui icon button" formaction="despesa-adicionar.php#taglist" formmethod="POST">
    ...
    <button class="ui right floated positive button" type="submit" formaction="despesa-repetir-salvar.php" formmethod="POST"><i class="save icon"></i>Salvar</button>
    <!-- botões do formulário -->
    <?php foreach ($tags as $index => $tag) : ?>
