...
<form class="ui form">
    ...
    <div class="fiels">
        <div class="three wide field">
            <div class="ui action input">
                ...
                <button class="ui icon button" formaction="lancar-repeticao-receita.php#taglist" formmethod="POST">
    ...
    <button class="ui right floated positive button" type="submit" formaction="adicionar-receita-repetida.php" formmethod="POST"><i class="save icon"></i>Salvar</button>
    <!-- botões do formulário -->
    <?php foreach ($tags as $index => $tag) : ?>
